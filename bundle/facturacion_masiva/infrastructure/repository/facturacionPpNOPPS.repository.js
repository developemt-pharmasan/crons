...
module.exports = async () => {
  ...
  inner join "FacturacionMasivas" t1 on t0."facturacionMasivaId" = t1."id" and t1."tipoFacturacionMasiva" in (5)
  where (t0."estado" = 0 or t0."estado" is null) and t0."NumFacturaResponse" is null 
    and (
          ...
          where s1."serviceLayer" = true and s2."tipoFacturacionMasiva" in (5)  and (s1."estado" = 0 or s1."estado" is null)
        ) = 0
  order by t0."id"
  limit 1
  `, options)
